...
class SdpOfferSent implements ShouldBroadcast
{
    ...
    public $senderId;
    public $receiverId;
    public $sdpOffer; // Le Session Description Protocol Offer

    /**
     * Crée une nouvelle instance d'événement.
     *
     * @param string $callUuid L'UUID unique de l'appel.
     * @param int $senderId L'ID de l'utilisateur qui envoie l'offre.
     * @param int $receiverId L'ID de l'utilisateur qui doit recevoir l'offre.
     * @param array $sdpOffer Le payload SDP de l'offre.
     */
    public function __construct(string $callUuid, int $senderId, int $receiverId, array $sdpOffer)
    {
     ...
     *
     * L'offre SDP est envoyée spécifiquement au destinataire de l'appel.
     *
    ...
    public function broadcastWith(): array
    {
        return [
            ...
            'type' => 'offer', // Type de signalisation
            'payload' => $this->sdpOffer,
        ];
    }
